...
function soundPlayer(key){
    switch (key) {
        case "w":
            ...
            break;
        case "a":
            var aSound= new Audio("kick-bass.mp3");
            aSound.play();
            break;    
        case "s":
            var sSound= new Audio("snare.mp3");
            sSound.play();
            break;
        case "d":
            var dSound= new Audio("tom-1.mp3");
            dSound.play();
            break;    
        case "j":
            var jSound= new Audio("tom-2.mp3");
            jSound.play();
            break;    
        case "k":
            var kSound= new Audio("tom-3.mp3");
            kSound.play();
            break;    
        case "l":
            var lSound= new Audio("tom-4.mp3");
            lSound.play();
            break;        
        default:
